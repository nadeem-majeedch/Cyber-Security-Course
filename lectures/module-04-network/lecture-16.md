...
| WPA3-SAE | Per-try handshake | Resists offline guessing ( Dragonblood-class research issues exist; still the better default — Vanhoef & Piessens, 2019) |
...
- Vanhoef, Y., & Piessens, F. (2019). *Dragonblood: Analyzing the Dragonfly Handshake of WPA3 and EAP-pwd.* USENIX Security Symposium. https://wpa3.matkke.nl
